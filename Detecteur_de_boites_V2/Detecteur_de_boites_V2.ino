 ...
 * Do something useful with the button on pin 2 (example: add or remove a count)
 */
...
int minimum_duration_detection=200;  // Minimum duration of detection to validate true positive (ms)
int minimum_wait_time=3000;  // Minimum delay between two different detections, to avoid counting same object twice (ms)
